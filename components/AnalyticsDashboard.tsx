...
import { FaAddressCard, FaBuilding, FaUser, FaUsers } from 'react-icons/fa'
...
const AnalyticsDashboard = ({
  ...
  return (
    <div className='flex flex-col gap-6'>
      <div className='grid w-full mx-auto grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
        <Card className='w-full text-sky-600'>
          <p className='text-tremor-default '>
             All Users
          </p>
          <div className='flex item-center mt-2 text-3xl font-semibold'>
                <FaUsers className='mr-4'/>{countUser}
          </div>
        </Card>
        <Card className='w-full text-sky-600'>
          <p className='text-tremor-default '>
          ...
          <p className='flex mt-2 text-3xl  font-semibold'>
                <FaBuilding className='mr-4'/>{countSchools}
          </p>
        </Card>
        <Card className='w-full text-sky-600'>
          <p className='text-tremor-default '>
          ...
          <p className='flex mt-2 text-3xl  font-semibold'>
                <FaAddressCard className='mr-4'/>{countRegistrations}
          </p>
        </Card>
        <Card className='w-full text-sky-600'>
          <p className='text-tremor-default '>
          ...
          <p className='flex mt-2 text-3xl  font-semibold'>
                <FaUser className='mr-4'/>{countApply}
          </p>
        </Card>
        <Card className='w-full text-sky-600'>
          <p className='text-tremor-default '>
          ...
          <p className='flex mt-4 text-3xl text-dark-tremor-content-strong font-semibold'>
            {avgVisitorsPerDay}
          </p>
        </Card>
        <Card className='w-full text-sky-600'>
      ...
      <Card className='flex flex-col sm:grid grid-cols-4 gap-6 text-sky-600'>
